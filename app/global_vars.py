...
aa = ["TRP", "THR", "ILE", "LEU", "LYS", "MET", "CYS", "PHE", "TYR", "VAL", "ARG", "HIS"]

# ENCODING PROTEIN FAMILIES AS INTEGERS

PROTEIN_FAMILY_ID = {"GLOBULIN": 1, "ALBUMIN": 2, "ALBUMINS": 2, "OVALBUMIN": 3, "OVOTRANSFERRIN": 4, "OVOMUCOID": 5,
                    "CASEIN": 6, "GLYCININ":7, "CONGLYCININ": 8, "GLUTELIN":9, "GLIADINS": 10, "ZEIN": 11,
                    "PROLAMIN": 12, "MYOSIN": 13, "MYOGLOBIN": 14, "PATATIN": 15, "LECTIN": 16, "LEGUMIN": 17, "OTHER": 18}

# ENCODING FOOD GROUPS AS INTEGERS: 

FOOD_GROUP_ID = {"Cereal & cereal products": 1, "Cereals & cereal products ": 1, "Roots & tubers": 2, "Legumes & oilseeds": 3, "Oil byproducts": 4, 
                "Fish & fish products": 5, "Animal products": 6, "Milk products": 7, "Fruits & vegetable products": 8, 
                "Others": 9, "Plant based ": 10, "Mixed food (animal + cereal product)": 11, "Mixed food (plant based)": 12,
                "Mixed food (cereal + legume)": 13, "Mixed food (cereal + animal product)": 14}

# AMINO ACID INDICES 

inds = ['ANDN920101', 'ARGP820101', 'ARGP820102', 'ARGP820103',
...
shap_features = ['Food Item', 'Energy (kJ/100g)', 'Dietary Fiber (g/100g)',
       'Fat (g/100g)', 'Ash (g/100g)', 'Total sugars (g/100g)',
       'Calcium (mg/100g)', 'Phosphorus (mg/100g)', 'Magnesium (mg/100g)',
       'Potassium (mg/100g)','Sodium (mg/100g)', 'Manganesem (mg/100g)', 'Zinc (mg/100g)',
        'Copper (mg/100g)','Iron (mg/100g)','Selenoim (ug/100g)','Protein',
        'TRP','THR','ILE','LEU','LYS','MET','CYS','PHE','TYR','VAL','ARG','HIS',
        '1st family','2nd family','3rd family','Food group',('2nd_JOND750102',),
        ('1st_KARS160118',),
        ('1st_FUKS010109',),
        ('1st_GEOR030105',),
        ('1st_AURR980118',),
